---
summary: "Coinbase Cartel claimed 5 UAE organisations inside two months of late 2025, its first activity in the country on record."
---
...
1. Plan for arrival rate rather than for a known list, because Coinbase Cartel went from absent
   to fifth place in one quarter.
2. Note the split between Financial Services and Retail and E-Commerce, which together carry 4
   of the 6 claims.
3. Establish whether DFSA Technology and Risk Management rules apply, which they do for firms
   authorised in the DIFC.
4. Map your obligations under the UAE Personal Data Protection Law, which covers payment and
   identity records held at volume.
5. Test the external perimeter on a schedule rather than after an incident, since a two-month
   burst leaves no time to react.
6. Retain the results of those tests as evidence, because assessors ask for demonstration rather
   than description.
7. Revisit this page as 2026 completes, given that the group remained active into March of that
   year.
